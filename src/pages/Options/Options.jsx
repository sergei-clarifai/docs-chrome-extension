          ...
          <aside className="w-64" aria-label="Sidebar">
            <div className="overflow-y-auto py-4 pr-4 pb-20 border-r border-gray-200">
              <ul className="space-y-2">
                  <li onClick={handleTabChange} data-tabId="github" className="tab-link flex items-center p-2 text-base font-normal text-slate-900 rounded-lg hover:bg-gray-100 cursor-pointer">
                  ...
                  <li onClick={handleTabChange} data-tabId="confluence" className="tab-link flex items-center p-2 text-base font-normal text-gray-900 rounded-lg hover:bg-gray-100 cursor-pointer">
                  ...
                  <li onClick={handleTabChange} data-tabId="google_drive" className="tab-link flex items-center p-2 text-base font-normal text-gray-900 rounded-lg hover:bg-gray-100 cursor-pointer">
              ...
              <div className="p-4 w-full bg-white rounded-lg">
                <form className="space-y-6" action="#" onSubmit={(event) => {
                  ...
                  saveToLocal('github', {
                    ...
                    <button id="saveBtn" type="submit" className="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Save Token</button>
                </form>
              </div>
            </section>
