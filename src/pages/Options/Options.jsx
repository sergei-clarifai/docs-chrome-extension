...
const Options = ({ title }) => {
  ...
  const handleTabChange = useCallback((e) => {
    ...
    setCurrentTab(listItem.getAttribute('data-tabId'));
  }, []);
          ...
          <aside className="w-64" aria-label="Sidebar">
            <div className="overflow-y-auto py-4 pr-4 pb-20 border-r border-gray-200 dark:border-slate-800">
              <ul className="space-y-2">
                  <li onClick={handleTabChange} data-tabId="github" className="tab-link flex items-center p-2 text-base font-normal text-slate-900 dark:text-white hover:bg-slate-900 rounded-lg cursor-pointer">
                    <svg className="w-6 h-6 text-slate-800 dark:text-white transition duration-75 " fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="p-4 px-10 pb-9 w-full bg-white dark:bg-[#0E172E] rounded-lg">
                <form className="space-y-6" action="#" onSubmit={(event) => {
                  ...
                  saveToLocal('github', {
                    ...
                    <h5 className="text-xl font-medium text-gray-900 dark:text-white">Enter your Credentials</h5>
                    <div>
                      <label
                        htmlFor="username"
            ...
            <section id="confluence-view" style={{ display: currentTab === 'confluence' ? 'block' : 'none' }}>
              <div className="p-4 px-10 pb-9 w-full bg-white dark:bg-[#0E172E] rounded-lg">
                <form className="space-y-6" action="#">
                    ...
                    <button id="saveBtn" type="submit" className="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Save</button>
                </form>
              </div>
            </section>
