          ...
          <aside className="w-64" aria-label="Sidebar">
            <div className="overflow-y-auto py-4 pr-4 pb-20 border-r border-gray-200 dark:border-slate-800">
              <ul className="space-y-2">
                  <li onClick={handleTabChange} data-tabId="github" className="tab-link flex items-center p-2 text-base font-normal text-slate-900 dark:text-white hover:bg-gray-100 hover:bg-slate-900 rounded-lg cursor-pointer">
                  ...
                  <li onClick={handleTabChange} data-tabId="confluence" className="tab-link flex items-center p-2 text-base font-normal text-slate-900 dark:text-white hover:bg-gray-100 hover:bg-slate-900 rounded-lg cursor-pointer">
                  ...
                  <li onClick={handleTabChange} data-tabId="google_drive" className="tab-link flex items-center p-2 text-base font-normal text-slate-900 dark:text-white hover:bg-gray-100 hover:bg-slate-900 rounded-lg cursor-pointer">
