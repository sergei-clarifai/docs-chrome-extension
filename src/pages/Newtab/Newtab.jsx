...
const SliderContainer = ({children, category, title, description}) => (
  <div className='flex flex-col w-full mb-12'>
    ...
    <p className="mt-1 mb-4 text-lg text-slate-700">{description}</p>
...
const Newtab = () => {
  return (
    ...
    <div className='box-border pb-20'>
      ...
      <div
        className="inset-0 bg-bottom bg-no-repeat bg-slate-50 index_beams__3fKa4"
        style={{
      ...
      >
        <div
          className="absolute inset-0 bg-grid-slate-900/[0.04] bg-[bottom_1px_center]"
          style={{
